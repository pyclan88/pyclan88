...
Я работаю с Kotlin, Java, MVVM, Room, Coroutines, Compose и т. д. В своих проектах следую принципам SOLID и Clean Architecture.
Делаю удобные, красивые и производительные Android-приложения.
